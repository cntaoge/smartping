...
```code
<p><code>timedatectl set-timezone Asia/Shanghai</br>yum update -y</br>yum install git -y</br>git clone -b master https://github.com/cntaoge/smartping.git</br>chmod -R 755 *</br>chmod -R a+x smartping</br>chmod -R 755 smartping</br>cd smartping</br>./control start</code></br>
```
...
```code
<p><code>cd /root/smartping;./control restart</code></br>
```
